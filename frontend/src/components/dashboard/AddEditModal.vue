                    ...
                    <div class="grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-6">
                      <div class="sm:col-span-6">
                        ...
                        <input
                          ...
                          class="p-2.5 h-10 mt-1.5 block w-full shadow-sm sm:text-sm border rounded-lg focus:ring-emerald-500 focus:border-emerald-500"
                          required
                        />
                      ...
                      <div class="sm:col-span-3">
                        ...
                        <select
                          ...
                          class="mt-1.5 block w-full pl-3 pr-10 py-2 text-base border rounded-lg focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm"
                        >
